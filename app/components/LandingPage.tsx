          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-8 items-center">
            ...
            <div className="mx-auto max-w-2xl text-center lg:mx-0 lg:text-left">
              ...
              <p className="mt-6 text-lg leading-8 text-slate-600">
                PanAI answers patient calls, processes OTC and prescription
                requests, and ensures nothing falls through the cracks — day or
                night. Built for modern pharmacies.
              </p>
              ...
              <div className="mt-12 grid grid-cols-3 gap-8 sm:gap-12">
                <div className="text-center lg:text-left">
                  ...
                  <div className="text-sm text-slate-600">Call Coverage</div>
                </div>
                <div className="text-center lg:text-left">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <div className="text-sm text-slate-600">Average Setup</div>
                </div>
              </div>
            </div>
      ...
      <section id="features" className="py-24 sm:py-32 bg-slate-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              A comprehensive AI assistant designed to streamline your pharmacy
              workflow and improve patient experience.
            </p>
          </div>
      ...
      <section id="compliance" className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              Built with pharmacy regulations in mind. PanAI meets all industry
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="rounded-2xl bg-white p-8 shadow-lg ring-1 ring-slate-200">
              ...
              <p className="mt-4 text-slate-600">
                Full HIPAA compliance with encrypted data transmission, secure
                storage, and comprehensive audit trails.
              </p>
            ...
            <div className="rounded-2xl bg-white p-8 shadow-lg ring-1 ring-slate-200">
              ...
              <p className="mt-4 text-slate-600">
                Designed to meet state and federal pharmacy regulations with
                built-in safeguards and compliance checks.
              </p>
              <div className="mt-6 flex flex-wrap gap-2">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-emerald-100">
              Join the growing number of pharmacies using PanAI to improve
