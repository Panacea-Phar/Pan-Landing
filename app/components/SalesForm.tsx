          ...
          {submitSuccess ? (
            <div className="rounded-xl bg-emerald-50 p-8 text-center shadow-lg ring-1 ring-emerald-200">
              ...
              <p className="text-emerald-700 mb-6">
                We've received your information and our sales team will contact
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="yes">
                          Yes — I make purchasing decisions
                        </option>
                        <option value="influence">
                          I have significant influence on purchasing decisions
                        </option>
                        <option value="no">
                          No — I'll refer this to the right person
                        </option>
                      </select>
                      {errors.decisionMaker && (
                        <p className="mt-1 text-sm text-red-600">
                ...
                <div className="rounded-xl bg-white p-8 shadow-lg ring-1 ring-slate-200">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      >
                        <option value="">Select pharmacy size</option>
